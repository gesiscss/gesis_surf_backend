...
# Create detailed URL
def detailed_url(global_session_id: str | UUID) -> str:
    """
...
class PrivateGlobalSessionApiTests(APITestCase):
    ...
    def test_create_global_session_invalid(self) -> None:
        ...
        """
        payload = {"start_time": "", "global_session_id": "session_12345"}
    ...
    def test_partial_update_global_session(self) -> None:
        ...
        session = create_global_session(
            user=self.user, global_session_id="session_12345"
        )

        payload = {"closing_time": datetime.now(timezone.utc)}
